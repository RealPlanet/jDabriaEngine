...
public class GLFWEventHandler {
    // FIXME :: This is OK but needs to handle ImGUI captures. For example if mouse cursor is over a ImGUI window, it should not pass the event to non-imgui listeners
